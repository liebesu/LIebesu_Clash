...
pub const RUNTIME_CONFIG: &str = "liebseu-clash.yaml";
pub const CHECK_CONFIG: &str = "liebseu-clash-check.yaml";
...
impl Config {
    ...
    help::save_yaml(&path, &config, Some("# Generated by Liebesu_Clash")).await?;
        Ok(path)
    }
